...
from ..data.datamodule import DataModuleConfig, PartitionConfig
from ..data.features import FeatureConfig
from ..models.multi_branch_model import MultiBranchModelConfig
...
def build_data_module_config(cfg: Dict[str, Any]) -> DataModuleConfig:
    ...
    return DataModuleConfig(
        ...
        dataset_variant=cfg.get("dataset_variant", DataModuleConfig.__dataclass_fields__["dataset_variant"].default),
    )
